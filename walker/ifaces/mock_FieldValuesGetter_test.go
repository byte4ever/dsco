...
func (_m *MockFieldValuesGetter) GetFieldValues(model ModelInterface) (fvalues.FieldValues, error) {
	ret := _m.Called(model)

	var r0 fvalues.FieldValues
	if rf, ok := ret.Get(0).(func(ModelInterface) fvalues.FieldValues); ok {
		r0 = rf(model)
	} else {
		if ret.Get(0) != nil {
