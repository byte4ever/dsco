...
func (_m *mockConstraintLayerPolicy) GetFieldValues(model ifaces.ModelInterface) (fvalues.FieldValues, error) {
	ret := _m.Called(model)

	var r0 fvalues.FieldValues
	if rf, ok := ret.Get(0).(func(ifaces.ModelInterface) fvalues.FieldValues); ok {
		r0 = rf(model)
	} else {
		if ret.Get(0) != nil {
