...
func Test_scan(t *testing.T) {
	...
	t.Run(
		"success", func(t *testing.T) {
			...
			e1xType := reflect.TypeOf(dsco.R(0))

			type E2 struct {
				E2X *string
			}

			e2xType := reflect.TypeOf(dsco.R(""))
			...
			sub1xType := reflect.TypeOf(dsco.R(float32(0.0)))
			sub1yType := reflect.TypeOf(dsco.R(0.0))
			...
			sub2xType := reflect.TypeOf(dsco.R(time.Duration(0)))
